import type { OnlyType, RPCProxy, RPCRequestArgs } from 'common/rpc/transport.ts';
import { RPC_EVENT, type RPCRequest, type RPCResponse } from 'common/rpc/transport.ts';
...
export class RPCClient {
  ...
  private createProxy(): RPCProxy {
    return new Proxy({} as RPCProxy, {
      get: <Scope extends OnlyType<keyof RPCProxy>>(_: any, scope: Scope) =>
        new Proxy(
          {},
          {
            get: <Method extends OnlyType<keyof RPCProxy[Scope]>>(_: any, method: Method) => {
